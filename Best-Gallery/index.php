<?php
$data['page'] = str_replace("-", " ", $_GET['page']);
$isi_file = file_get_contents('../result/'.$data['page'].'.rahasia');
$arr_isi_file = unserialize($isi_file);
...
<!DOCTYPE html>
<html lang="en">
<title>Best Gallery - <?php echo $data['page']; ?></title>
...
<div class="w3-top">
  ...
  <div class="w3-row w3-padding-64">
    <div class="w3-twothird w3-container">
      <h1 class="w3-text-teal">Best Gallery - <?php echo $data['page']; ?></h1>
      <div class="w3-row">
        <div class="w3-half" style="width:100%">
        <div class="grid-container">
          <?php foreach ($arr_isi_file as $key): ?>
          	
          		<?php 
          			if(strpos($key, "jpg") !== false || strpos($key, "png") !== false || strpos($key, "gif") !== false) {
          		?>
          		<div>
          		<a href="<?php echo $key ?>">
          			<img src="<?php echo $key ?>" alt="<?php echo $data['page']; ?>" title="<?php echo $data['page']; ?>" height="200" width="200" class="img-responsive">
          		</a>
          		</div>
          		<?php
          			}
    ...
    <div class="w3-third w3-container">
      <p class="w3-border w3-padding-large w3-padding-15 w3-center" style="background-color:Tomato;">Popular Articles</p>
            <div class="w3-container cw3-cell" style="color:Tomato;">
              <?php foreach ($allkeywords as $key): ?>
              <ul>
                <a href="?page=<?php echo str_replace(" ", "-", $key) ?>"><?php echo $key?></a>
              </ul>
            <?php endforeach ?>
            </div>
<p class="w3-border w3-padding-large w3-padding-64 w3-center">Teks adsense</p>
    </div>
  </div>
